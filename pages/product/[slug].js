...
const Post = ({ buyNow, addToCart, product, varients }) => {
  ...
  const checkServiceAbility = async () => {
    ...
    if (pinJson.includes(parseInt(pin))) {
      setService(true);
      toast.success("Your pincode is sucessible", {
      ...
      setService(false);
      toast.error("Soory Your pincode is not sucessible", {
        position: "bottom-center",
        autoClose: 1000,
        hideProgressBar: false,
        closeOnClick: true,
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              className="lg:w-60 mx-20 w-full lg:h-auto   object-center rounded"
              src={product.img}
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button
                  ...
                  className="flex ml-12 text-white bg-pink-500 border-0 py-0 text-sm md:text-xl px-3 md:px-5 focus:outline-none hover:bg-pink-600 rounded"
                >
                  Buy Now
                </button>
                <button
                  ...
                  className="flex ml-6 text-white bg-pink-500 border-0 py-0 text-sm md:text-xl  px-1 md:px-5 focus:outline-none hover:bg-pink-600 rounded"
                >
                  Add to cart
                </button>
              ...
              <div className="pim mt-6 flex space-x-2 text-sm">
                <input
                  onChange={onchangePin}
                  type="text"
                  className="px-2 border-gray-400 border-2 rounded-md"
                />
                <button
              ...
              {!service && service != null && (
                <div className="text-red-700 text-sm mt3">
                  Sorry! we unable to deliver this in your area
                </div>
              )}
              {service && service != null && (
                <div className="text-green-600 text-sm mt3">
                  Yay! It is avaible at your area
                </div>
              )}
            </div>
          </div>
